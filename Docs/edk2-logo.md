...
- **Compress解压缩**: BaseTools/Source/C/bin/LzmaCompress -d old.bin -o old.bmp
- **Un-Compress压缩**: BaseTools/Source/C/bin/LzmaCompress -e new.bmp -o new.bmp.lzma
...
```
## 4. 替换 logo
**确保原有Logo是否经过压缩?** 如压缩,请将原数据进行Lzma压缩:
